<div id="{{ isset($id) ? $id : 'modal' }}" class="modal fixed hidden z-10 inset-0 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen p-4 text-center sm:block sm:p-0">
        ...
        <form method="POST" action="{{ route('project.create') }}" class="w-full">
            @csrf
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <div class="flex flex-col w-full">
                                    <input type="projectTitle" name="projectTitle" id="projectTitle" placeholder="Project Title" 
                                    ...
                                    <div class="flex w-full mt-2">
                                        ...
                                        <input name="projectColor" type="color" style='opacity:0; width:100px; 
